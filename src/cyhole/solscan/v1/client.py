...
class SolscanClient(APIClient):
    ...
    def get_transaction_last(self, limit: int = 10) -> GetTransactionLastResponse:
        """
            ...
            All the API endopint details are available on [`Solscan._get_transaction_last`][cyhole.solscan.interaction.v1.Solscan._get_transaction_last].
        """
    ...
    def get_transaction_detail(self, transaction_id: str) -> GetTransactionDetailResponse:
        """
            ...
            All the API endopint details are available on [`Solscan._get_transaction_detail`][cyhole.solscan.interaction.v1.Solscan._get_transaction_detail].
        """
    ...
    def get_block_last(self, limit: int = 10) -> GetBlockLastResponse:
        """
            ...
            All the API endopint details are available on [`Solscan._get_block_last`][cyhole.solscan.interaction.v1.Solscan._get_block_last].
        """
    ...
    def get_block_detail(self, block_id: int) -> GetBlockDetailResponse:
        """
            ...
            All the API endopint details are available on [`Solscan._get_block_detail`][cyhole.solscan.interaction.v1.Solscan._get_block_detail].
        """
    ...
    def get_block_transactions(self, block_id: int, limit: int = 10, offset: int | None = None) -> GetBlockTransactionsResponse:
        """
            ...
            All the API endopint details are available on [`Solscan._get_block_transactions`][cyhole.solscan.interaction.v1.Solscan._get_block_transactions].
        """
