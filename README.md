...
|Site                                         |Path                    |Connector                                                                                                                                                                |
|----                                         |----                    |---------                                                                                                                                                                |
|[helius.dev](https://www.helius.dev)          |`cyhole.helius`         |[`Helius`](https://zazza123.github.io/cyhole/interactions/helius/index.html)                                                                                             |
|[geckoterminal.com](https://www.geckoterminal.com/dex-api) |`cyhole.gecko`        |[`Gecko`](https://zazza123.github.io/cyhole/interactions/gecko/index.html)                                                                                               |
...
|~~[solana.fm](https://solana.fm)~~           |~~`cyhole.solana_fm`~~  |~~`SolanaFM`~~ — *removed in `0.3.1` (API deprecated)*                                                                                                                   |
|[rugcheck.xyz](https://rugcheck.xyz)         |`cyhole.rugcheck`       |[`Rugcheck`](https://zazza123.github.io/cyhole/interactions/rugcheck/index.html)                                                                                         |
